...
function Header() {
  ...
  return (
    <>
      <nav className="min-h-14 sticky top-0 z-10 bg-cyan-500 flex w-full items-center justify-between shadow ">
        <div className="lg:ml-32 ml-3 sm:ml-14 md:ml-10 font-bold text-2xl text-white">
          Dr. Laxman Yadav
        </div>
        {/* /humburger menu */}
